    ...
    <div class="container">
        <div class="row">
            ...
            <div id="MenuFooter" class="col l3 s9">
                ...
                <ul>
                    <li><a class="text-green darken-4" href="../accueil.php">Home</a></li>
                    <li><a class="text-green darken-4" href="../boutique.php">Boutique</a></li>
                </ul>
            </div>
            <div id="PagesFooter" class="col l3 s12">
                <h5 class="titleFooter">ACCES</h5>
                <ul>
                    <li><a class="text-green darken-4" href="../Inscription.php">Inscription</a></li>
                    <li><a class="text-green darken-4" href="../connexion.php">Connexion</a></li>
                    <li><a class="text-green darken-4" href="../profil.php">Mon compte</a></li>
                    <li><a class="text-green darken-4" href="../admin.php">Admin</a></li>
                </ul>
            </div>
        </div>
    </div>
