    ...
    <div class="container">
        <div class="row">
            <div id="infosCompany" class="col l3 s3">
                <div id="logoResponsiveFooter"><img src="../images/imagessite/Capture1.PNG" id="logoFooter"
                                                    alt="Logo Jungle Gardener"></div>
                <p id="textFooter" class="text-green darken-4"><strong>JUNGLE GARDENER</strong><br>8 RUE D'HOZIER<br>13002
                    MARSEILLE</p>
            ...
            <div id="PagesFooter" class="col l3 s12">
                ...
                <ul>
                    <?php
                    if (!isset($_SESSION['user']) || empty($_SESSION['user']->getEmail())) : ?>
                    ...
                    <?php
                    elseif (isset($_SESSION['user']) && !empty($_SESSION['user']->getEmail())) : ?>
                        <li><a class="text-green darken-4" href="../Views/moncompte.php">Mon compte</a></li>
                        <li><a class="text-green darken-4"
                               href="<?= $_SERVER['REQUEST_URI'] ?>?disconnect">Deconnexion</a></li>
                        <?php
                        if (isset($_SESSION) && !empty(
                            $_SESSION['user']->getEmail()
                            ) && $_SESSION['user']->getId_rights() == 42) : ?>
