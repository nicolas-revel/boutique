    ...
    <nav id="navBar">
        <div id="navBarUser">
            <ul class="right hide-on-med-and-down">
                <?php
                if (empty($_SESSION['user']) || empty($_SESSION['user']->getEmail())) : ?>
                ...
                <?php
                elseif (!empty($_SESSION['user']->getEmail())) : ?>
                    <li><a href="../Views/apropos.php">QUI SOMMES-NOUS?</a></li>
                    <li><a href="../Views/moncompte.php">MON COMPTE</a></li>
                    <?php
                    if ($_SESSION['user']->getId_rights() == 42) : ?>
        ...
        <div class="nav-wrapper">
            <a href="../Views/accueil.php" class="brand-logo">
                <div id="logoResponsive"><img src="../images/imagessite/logoJungle1.PNG" id="logoHeader"
                                              alt="Logo Jungle Gardener"></div>
            </a>
            <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
            <ul id="navMenu" class="right hide-on-med-and-down">
                <li><a href="../Views/accueil.php">HOME</a></li>
                <li><a class="dropdown-trigger" href="#" data-target="dropdown1">BOUTIQUE<i
                ...
                if (!isset($_SESSION['panier']['verrouille']) || $_SESSION['panier']['verrouille'] == false) : ?>
                    <?php
                    if (isset($_SESSION['panier']) && !empty($_SESSION['panier']) && isset($_SESSION['user']) && !empty($_SESSION['user'])) : ?>
                        <li id="liPanier"><a href="../Views/panier.php">PANIER (<?= number_format(
                                    $ControlPanier->totalPrice(),
                                    2,
                                    ',',
                                    ' '
                                ) ?> €)</a></li>
...
<ul class="sidenav" id="mobile-demo">
    ...
    <?php
    elseif ($_SESSION['user']->getId_rights() == 42) : ?>
        <li><a href="../Views/admin.php">ADMIN</a></li>
    <?php
    endif; ?>
    <br>
