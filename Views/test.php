...
<!-- PAGE PANIER + POSSIBILITE MODIFICATION DU PANIER -->
    ...
    <?php if(!empty($_SESSION['panier'])){ var_dump($_SESSION['panier']);} ?>
        ...
        <table>
            <tr>
                <?php $viewPanier->showImagePanier(); ?>
            </tr>
            <tr>
                <?php $viewPanier->showNamePanier(); ?>
            </tr>
            <tr>
                <?php $viewPanier->showQuantityPanier(); ?>
            </tr>
            <tr>
                <?php $viewPanier->showPricePanier(); ?>
            </tr>
            <tr>
                <?php $viewPanier->showPriceTotalProductPanier(); ?>
            </tr>
                <?php if(isset($_POST['modifier'])){
                        $controlPanier->modifQuantityFromPanier ();
                        Header('Location: panier.php');} ?>
            <tr>
                <?php $viewPanier->showDeleteButton (); ?>
            </tr>
