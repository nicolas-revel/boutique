        ...
        <div class="carousel carousel-slider" id="demo-carousel-auto" data-indicators="true">
            <div class="carousel-item" id="carouselPictures1">
                <div class="carousel-fixed-item center" id="btnFirst">
                    <a class="btn waves-effect transparent white-text green darken-text-4 share-btn"
                       href="boutique.php">DECOUVRIR</a>
                </div>
            </div>
            <div class="carousel-item" id="carouselPictures2">
                <div class="carousel-fixed-item center" id="btnSecond">
                    <a class="btn waves-effect transparent white-text green darken-text-4 share-btn"
                       href="boutique.php?categorie=<?= $controlAccueil->getIdTerrarium(); ?>">DECOUVRIR</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="lastComment">
        <div id="mapAdress">
            ...
            <div id="imgVisite">
                ...
                <div id="adresseShop">
                    <p id="textFooter" class="text-green darken-4"><strong>JUNGLE GARDENER</strong><br>8 RUE
                        D'HOZIER<br>13002 MARSEILLE</p>
                </div>
                <div id="telMail">
