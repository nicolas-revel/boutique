...
?>
    ...
    <main id="mainBoutique">
        <article id="panierDetails">
            ...
            <?php
            if (!isset($_GET['delivery']) && !isset($_GET['expedition']) && !isset($_GET['checkout']) && !isset($_GET['command'])): ?>
                <?php
                $pageTitle = 'PANIER'; ?>
            ...
            <?php
            if (isset($_SESSION['panier']) && isset($_GET['delivery']) && !isset($_GET['checkout']) && !isset($_GET['command']) && !isset($_GET['expedition'])): ?>
                <?php
                $pageTitle = 'INFORMATIONS COMMANDE'; ?>
                <div class="titlePanier">
                ...
                <section id="modifFormAdress">
                    <div id="chooseAdress">
                        ...
                        if (!isset($_SESSION['user']) && empty($_SESSION['user'])): ?>
                            <div id="noConnect">
                                ...
                                <p class="flow-text" id="textConnect">N'hésites pas à t'inscrire ou te connecter et
                                    sauvegarde tes informations pour tes prochaines commande !</p>
                                <div id='co'>
                        ...
                        <?php
                            ...
                            <div id="noConnect">
                                ...
                                <p class="flow-text" id="textConnect">Choisie ton adresse de livraison dans celle déjà
                                    existantes ou ajoutes-en une nouvelle !</p>
                            </div>
                            <?php
                            ...
                            <?php
                            elseif (isset($_SESSION['adress']) && !empty($_SESSION['adress'])): ?>
                    ...
                    <?php
                    if (empty($_SESSION['lastname']) && empty($_SESSION['firstname']) && empty($_SESSION['email']) && empty($_SESSION['adress_Name'])): ?>
                        <?php
                        $viewPanier->showFormAddAdress(); ?>
                    <?php
                    else: ?>
                ...
                <div class="table">
                    ...
                    <p id="totalTaxe">TOTAL <i>(taxe de 2,00€ incluse)</i>: <b><?= number_format(
                                $controlPanier->totalPrice() + 2,
                                2,
                                ',',
                                ' '
                            ) ?> €</b></p>
            ...
            <?php
            if (isset($_SESSION['panier']) && isset($_GET['expedition']) && !isset($_GET['delivery']) && !isset($_GET['checkout']) && !isset($_GET['command'])): ?>
                <?php
                ...
                <section id="chooseExpe">
                    <?php
                    if (empty($_SESSION['fraisLivraison']) && empty($_SESSION['totalCommand'])): ?>
                    ...
                    <div id="recupInfosUser">
                        <p id="recapMail"><b>EMAIL :</b> <?php
                            if (isset($_SESSION['user'])) {
                                echo $_SESSION['user']->getEmail();
                            } else {
                                echo $_SESSION['email'];
                            } ?></p><br>
                        <p id="recapAdress"><b>EXPEDIER A :</b> <?php
                            if (isset($_SESSION['adress'])) {
                                echo $_SESSION['adress'];
                            } else {
                                echo $_SESSION['adress_Name'];
                            } ?></p>
                    </div>
                </section>
                <div class="titlePanier">
                ...
                <div id="pricesTotal">
                    <p>Total (taxe de 2,00€ incluse): <b><?= number_format(
                                $controlPanier->totalPrice() + 2,
                                2,
                                ',',
                                ' '
                            ) ?> €</b></p>
                    <p>Frais de livraison : <b><?php
                            if (isset($_SESSION['fraisLivraison'])) {
                                echo number_format($_SESSION['fraisLivraison'], 2, ',', ' ') . '€';
                            } else {
                                echo '0,00 €';
                            } ?></b></p>
                    <p>Total : <b><?php
                            if (isset($_SESSION['totalCommand'])) {
                                echo number_format($_SESSION['totalCommand'], 2, ',', ' ') . ' €';
                            } else {
                                echo '0,00 €';
                            } ?></b></p>
                </div>
            ...
            if (isset($_SESSION['panier']) && !isset($_GET['expedition']) && !isset($_GET['delivery']) && isset($_GET['checkout']) && !isset($_GET['command'])): ?>
                ...
                <section id="finalCommand">
                    ...
                    <form id="formPayment" method="post">
                        ...
                        <button class="buttonFilter" id="card-button" type="button"
                                data-secret="<?= $intent['client_secret'] ?>">Procéder au paiement
                        </button>
                    </form>
            ...
            <?php
            if (isset($_GET['command']) && !isset($_GET['delivery']) && !isset($_GET['expedition']) && !isset($_GET['checkout'])): ?>
            <?php
            $pageTitle = 'CONFIRMATION COMMANDE'; ?>

            <section id="confirmPayment">
                <div id="confirmAddCommand">
                    <img src="../images/imagessite/confirmCommand.gif" id="gifConfirm"
                         alt="Animation confirmation Paiement">
                ...
                <section id="finalCommand">
                    ...
                    <div id="detailsAdressUser">
                        ...
                        if (!empty($_SESSION['user'])): ?>
                            <?php
                            $viewPanier->showDetailsExpedition(intval($_SESSION['user']->getId_user())); ?>
                        <?php
                        else: ?>
                            <?php
                            $viewPanier->showDetailsGuest(); ?>
                        <?php
                        endif; ?>
                    </div>
                </section>
